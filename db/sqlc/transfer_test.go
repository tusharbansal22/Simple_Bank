...
func TestGetTransferFromAccountID(t *testing.T) {
	...
	arg := GetTransfersFromAccountIDParams{
		FromAccountID: account1.ID,
		Limit:         5,
		Offset:        5,
	}

	transfers, err := testQueries.GetTransfersFromAccountID(context.Background(), arg)
...
func TestGetTransferToAccountID(t *testing.T) {
	...
	arg := GetTransfersToAccountIDParams{
		ToAccountID: account2.ID,
		Limit:       5,
		Offset:      5,
	}

	transfers, err := testQueries.GetTransfersToAccountID(context.Background(), arg)
